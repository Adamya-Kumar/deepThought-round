                ...
                task.assets.forEach(asset => {
                    ...
                    card.innerHTML = `
                        ...
                        <div class="card-content">
                            ...
                            ${asset.asset_content_type === 'video' ? `<iframe src="${asset.asset_content}" frameborder="0" allowfullscreen></iframe>` : ''}
                            ${asset.asset_content_type === 'threadbuilder' ? `
                                <div>
                                    ...
                                    <button class="btn">Sub-thread</button>
                            ...
                            ${asset.asset_content_type === 'article' && asset.asset_content.trim() !== '' ? `<a href="${asset.asset_content}">Read More</a>` : ''}
                        </div>
                    `;
